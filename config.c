...
void read_config(const char* filename) {
    ...
    while (fgets(line, sizeof(line), file)) {
        ...
        if (strstr(line, "prison_duration")) sscanf(line, "prison_duration=%d", &config.prison_duration);
        ...
        if (strstr(line, "agent_discovery_chance")) sscanf(line, "agent_discovery_chance=%d", &config.agent_discovery_chance);
